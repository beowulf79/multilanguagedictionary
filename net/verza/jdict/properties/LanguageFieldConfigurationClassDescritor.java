...
public class LanguageFieldConfigurationClassDescritor {
	...
	public String getAttributeName() {
		log.trace("called function getAttributeName; will return "+this.attributeName);
		return this.attributeName;
	}

	
	public void setAttributeName(String _attributeName) {
		log.trace("called function setAttributeName with parameter  "+_attributeName);
		this.attributeName = _attributeName;
	}

	
	public String getInputLabel() {
		log.trace("called function getInputLabel; will return "+this.inputLabel);
		return inputLabel;
	}
	...
	public Boolean getAttributeHasAudio() {
		log.trace("called function getAttributeHasAudio; will return "+this.attributeHasAudio);
	...
	public String getIndex_class_creator() {
		log.trace("called function getIndex_class_creator; will return "+this.index_class_creator);
		return this.index_class_creator;
	}

	
	public void setIndex_class_creator(String _indexc) {
		log.trace("called function setIndex_class_creator  with parameter  "+_indexc);
		this.index_class_creator = _indexc;
	}

	
	public Boolean getMultivalue() {
		log.trace("called function getMultivalue; will return "+this.multivalue);
		return this.multivalue;
	}

	
	public void setMultivalue(Boolean multivalue) {
		log.trace("called function setMultivalue  with parameter   "+multivalue);
	...
	public String toString()	{
		...
		+ " key_type " + key_type
		+ " attributeHasAudio " + attributeHasAudio
		+ " index_class_creator " + index_class_creator
