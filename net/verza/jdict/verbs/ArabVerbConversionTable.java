...
public class ArabVerbConversionTable {
	...
	public void setParadigm(String _paradigm) throws DataNotFoundException {
		...
		if ( _paradigm == null ) {
				...
				throw new DataNotFoundException("the paradigm code given is not valid");
			}
				
			past_vowels = ArabVerbPastParadigm2ShortVowels.getShortVowels(_paradigm).toCharArray();
			present_vowels = ArabVerbPresentParadigm2ShortVowels.getShortVowels(_paradigm).toCharArray();
