...
public class DatabaseWriterTestClass {
	...
	private static void write()	{
		try  {
			...
			langconf = LanguagesConfiguration.getLanguageMainConfigNode("italianword");
			if(langconf.getIsEnabled()) {
				...
				log.trace("getting italian word database");
			...
			langconf = LanguagesConfiguration.getLanguageMainConfigNode("italianverb");
			if(langconf.getIsEnabled()) {
				...
				log.trace("getting italian verb database");
			...
			if(langconf.getIsEnabled()) {
				...
				log.trace("opening english verb database");
			...
			langconf = LanguagesConfiguration.getLanguageMainConfigNode("arabicword");
			if(langconf.getIsEnabled()) {
			...
			langconf = LanguagesConfiguration.getLanguageMainConfigNode("arabicverb");
			if(langconf.getIsEnabled()) {
