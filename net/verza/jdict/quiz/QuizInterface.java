...
public abstract class QuizInterface {
	...
	public void setSectionIndex(String value, String lang) throws DatabaseException,
		...
		log.debug("activating section sub index on database with value " + value);

		DatabaseEntry entry = new DatabaseEntry();
		
		System.out.println("dit.readSectionDatabase(value) "+dit.readSectionDatabase(value));
		
		StringBinding.stringToEntry(dit.readSectionDatabase(value),
									entry);
