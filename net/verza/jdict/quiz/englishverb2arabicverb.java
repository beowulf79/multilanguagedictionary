 ...
 * 
 */
public class englishverb2arabicverb extends QuizInterface {
	 ...
	 */
	public englishverb2arabicverb() throws DatabaseException,
		...
		this.targetLanguage = "arabicverb";
	...
	public int load() throws UnsupportedEncodingException, DatabaseException,
		...
		while (counter < iterations) {
			...
			quizResult.setQuizType(Configuration.ENGLISH2ARABIC);
