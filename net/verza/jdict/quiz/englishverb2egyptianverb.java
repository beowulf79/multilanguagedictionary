 ...
 * 
 */
public class englishverb2egyptianverb extends QuizAbstract {
	...
	public void load() throws UnsupportedEncodingException, DatabaseException,
		...
		localKeyArray = (Vector<Verb>) dit.read("englishverb").clone();
		...
		while ((max_loop_counter++ < Configuration.QUIZMAXLOOPS)
			...
			quizResult.setQuizType(Configuration.ENGLISH2EGYPTIAN);
