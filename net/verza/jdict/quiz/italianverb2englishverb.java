...
public class italianverb2englishverb extends QuizAbstract {
	 ...
	 */
	public italianverb2englishverb() throws DatabaseException,
		...
		this.targetLanguage = "englishverb";
	...
	public int load() throws UnsupportedEncodingException, DatabaseException,
		...
		while (counter < iterations) {
			...
			localDataArray = (Vector<Verb>) dit.read("italianverb",
					key.getid().toString(), "englishverb").clone();
