 ...
 * 
 */
public class audio2englishword extends QuizAbstract {
	 ...
	 */
	public audio2englishword() throws DatabaseException, FileNotFoundException,
	...
	public void load() throws UnsupportedEncodingException, DatabaseException,
		...
		while ((max_loop_counter++ < Configuration.QUIZMAXLOOPS)
			...
			quizResult.setQuizType(Configuration.AUDIO2ENGLISH);
