 ...
 * 
 */
public class egyptianword2englishword extends QuizInterface {
	 ...
	 */
	public egyptianword2englishword() throws DatabaseException,
	...
	public int load() throws UnsupportedEncodingException, DatabaseException,
		...
		while (counter < iterations) {
			...
			quizResult.setQuizType(Configuration.EGYPTIAN2ENGLISH);
			...
			localDataArray = (Vector<Word>) dit.read("egyptianword",
