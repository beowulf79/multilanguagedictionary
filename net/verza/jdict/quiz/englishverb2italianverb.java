 ...
 * 
 */
public class englishverb2italianverb extends QuizInterface {
	 ...
	 */
	public englishverb2italianverb() throws DatabaseException,
	...
	public int load() throws UnsupportedEncodingException, DatabaseException,
		...
		while (counter < iterations) {
			...
			localDataArray =  (Vector<Verb>) dit.read("englishverb",
													key.getid().toString(), 
													"italianverb").clone();
