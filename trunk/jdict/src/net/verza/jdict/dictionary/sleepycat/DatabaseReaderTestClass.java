...
public class DatabaseReaderTestClass {
	...
	try {
		...
		System.out
			.print("Enter the index name to be used with the query (if null primary key is assumed) : ");
	...
	System.out.println("reading using language " + _language + " key "
		+ _key + " index " + _index);
	try {

	    DatabaseEntry theKey = null;
	    if (_index.equals("section") || _index.equals("category")) {
