...
public class PropertiesLoader {
	...
	private  static String propertyFilename 
				= "/Users/ChristianVerdelli/documents/workspace/jdict/conf/new_properties.xml";
	...
	private static void loadConfiguration(){
		...
		{
			log.fatal("Impossibile caricare il file di properties " + propertyFilename, e);
			e.printStackTrace();
		}
	}
	...
	public static List<org.apache.commons.configuration.SubnodeConfiguration> getHierarchicalProperty(String prop_name) {
