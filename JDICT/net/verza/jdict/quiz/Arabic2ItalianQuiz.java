 ...
 * 
 */
public class Arabic2ItalianQuiz extends QuizInterface {
	 ...
	 */
	public Arabic2ItalianQuiz() throws DatabaseException,
	...
	public int load() throws UnsupportedEncodingException, DatabaseException,
		...
		while (counter < iterations) {
			...
			log.trace("setting quiztype to ARABIC2ITALIAN " + " Word_ID "
					+ data.getid() + " Question " + data.getsingular());
			...
			// if present
			quizResult.setQuestion( (data.getcomment() == null) ? data
					.getsingular() : data.getsingular() + " ("
					+ data.getcomment() + ")");
