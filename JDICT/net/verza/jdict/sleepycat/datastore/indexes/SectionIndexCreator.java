...
public class SectionIndexCreator implements SecondaryMultiKeyCreator {

	private final static String index_name = "SECTION_MULTI_VALUE_INDEX";
	private Logger log;

	public SectionIndexCreator() {
	...
	public void createSecondaryKeys(SecondaryDatabase secondary,
		...
		System.out.println("pd.getsection() "+pd.getsection().size() );
		copyKeysToEntries(pd.getsection(), results);
