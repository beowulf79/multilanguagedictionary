 ...
 * 
 */
public class SleepyVerbsDatabaseReader {

	
	private SleepyVerbsDatabase db;
	private SleepyVerbsDatabasePrimaryCursor primaryCursor;
	...
	public SleepyVerbsDatabaseReader(SleepyVerbsDatabase _sleepydb)
		...
		db = _sleepydb;
		primaryCursor = new SleepyVerbsDatabasePrimaryCursor(db);
	...
	public void setSecondaryCursor(SecondaryDatabase secdb, DatabaseEntry key)
		...
		SleepyVerbsDatabaseSecondaryXCursor Xcursor = new SleepyVerbsDatabaseSecondaryXCursor(
				secdb);
	...
	private  Vector<SearchableObject>  readJoin() throws DatabaseException, DynamicCursorException {
		...
		while (joinCursor.getNext(theKey, theData, LockMode.DEFAULT) == OperationStatus.SUCCESS) {
				SearchableObject verb = (SearchableObject)this.dataBinding.entryToObject(theData);
				local_wdata.addElement(verb);
		}
