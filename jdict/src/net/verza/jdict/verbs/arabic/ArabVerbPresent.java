...
public class ArabVerbPresent implements ArabVerbFormInterface {
    ...
    public ArabVerbPresent(char[] root, String paradigm)
	...
	return new String[][] { { ArabVerbPronoun.I_P_SING, I_P_SING }, // corresponds
									// ANA
		{ ArabVerbPronoun.II_P_SING_F, II_P_SING_F }, // corresponds
								// to ANTI
		{ ArabVerbPronoun.I_P_PLUR, I_P_PLUR } }; // corresponds to
							    // NAHNU
    }
