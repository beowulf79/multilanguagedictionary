...
public class WordEditor extends SearchableObjectEditor implements
	ActionListener {
    ...
    public WordEditor(SearchableObject _word, String language)
	    ...
	    DynamicCursorException, KeyNotFoundException {
	this(language);
	log.trace("called constructor WordEditor(with word " + _word.toString()
