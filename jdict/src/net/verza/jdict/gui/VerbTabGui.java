...
import net.verza.jdict.verbs.arabic.ArabVerbFormInterface;
...
public class VerbTabGui extends JPanel {
	...
	verbJTextField = new JTextField("\u0625" + "\u0631" + "\u0633"
		+ "\u0644"); // corresponds
	// to
	// Arabic
	// IRSAL
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (command.equals("Conjugate")) {
		    ...
		    ArabVerbFormInterface obj = (ArabVerbFormInterface) constr
			    .newInstance(
				    verbJTextField.getText().toCharArray(),
				    // The root of the verb
				    paradigmJSpinner.getValue().toString());
		    // The Paradigm
